...
namespace EstateAgent
{
    public partial class formOffer : Form
    {
        ...
        {
            if (txtAmt.Text.All(char.IsDigit))
            {
                if (txtOffer.Text != "")
                {
            ...
            {
                MessageBox.Show("Enter Numeric value for Offer Amount");
            }
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string queryChangeStatus = "update estate.property set Status = 'Available' where propertyID= '" + txtOffer.Text + "' ;";
                MySqlConnection conDataBase = new MySqlConnection(constr);
                MySqlCommand cmdDataBase = new MySqlCommand(query, conDataBase);
                MySqlDataReader myReadr;
                try
                ...
                MySqlConnection conDataBs1 = new MySqlConnection(constr);
                        MySqlCommand cmdDataBs1 = new MySqlCommand(queryChangeStatus, conDataBs1);
                        MySqlDataReader myReader;

                        try
                        {
                            conDataBs1.Open();
                            myReader = cmdDataBs1.ExecuteReader();
                            while (myReader.Read())
                            {
                            }
                        }
        ...
        private void onDeleteChangeStatusToAvailable()
        {
