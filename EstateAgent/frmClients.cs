...
namespace EstateAgent
{
    public partial class frmClients : Form
    {
        ...
        {
            if(txtPNum.Text.All(char.IsDigit))
            {
                if(!txtAddress.Text.All(char.IsDigit))
                {
                    if (txtFName.Text.Any(char.IsDigit) || txtLName.Text.Any(char.IsDigit))
                    {
                ...
                {
                    MessageBox.Show("Address Cannot be all numbers!");
                }
        ...
        {
            if(txtFName.Text=="" || txtLName.Text=="" || txtAddress.Text=="" || txtPNum.Text=="")
            {
        ...
        {
            if (txtPanelOwnersPhone.Text.All(char.IsDigit))
            {
                if (!txtPanelOwnersAddress.Text.All(char.IsDigit))
                {
                    if (txtPanelOwnersFName.Text.Any(char.IsDigit) || txtPanelOwnersLName.Text.Any(char.IsDigit))
                    {
                        MessageBox.Show("Names cannot contain numbers!");
                    }
                    else
        ...
        {
            if (txtPanelOwnersFName.Text == "" || txtPanelOwnersLName.Text == "" || txtPanelOwnersAddress.Text == "" || txtPanelOwnersPhone.Text=="")
            {
                MessageBox.Show("Enter all Details");
            }
            else
