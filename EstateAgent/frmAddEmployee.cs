...
namespace EstateAgent
{
    public partial class frmAddEmployee : Form
    {
        ...
        {
            if(txtBoxFname.Text=="" || txtBoxSurname.Text=="" || txtBoxPassword.Text=="" || txtBoxSalary.Text=="")
            {
                MessageBox.Show("Enter All Details");
            }
            else
            {
                if (txtBoxSalary.Text.All(char.IsDigit))
                {
                    if(!txtBoxFname.Text.Any(char.IsDigit) || !txtBoxSurname.Text.Any(char.IsDigit))
                    {
                ...
                {
                    MessageBox.Show("Enter Numeric Value for Salary!");
                }
            }
