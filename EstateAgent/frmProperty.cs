...
namespace EstateAgent
{
    public partial class frmProperty : Form
    {
        ...
        private void btnUpdate_Click_1(object sender, EventArgs e)
        {
            ...
            {
                if (txtPrice.Text.All(char.IsDigit) && txtHouseNum.Text.All(char.IsDigit))
                {

                    if (txtAddress.Text == "" || txtPrice.Text == "" || txtTown.Text == "")
                    {
                        MessageBox.Show("Please Enter all details to update!");
                    }
                    else
                    {
                ...
                {
                    MessageBox.Show("Enter Valid value for Price and House Number!");
                }
            }
            else
            {
