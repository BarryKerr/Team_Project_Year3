...
namespace EstateAgent
{
    ...
    {
        private int ownerID;
        private List<string> typeArray = new List<string>{"Choose","For Sale","For Rent"};
        private List<string> propertyTypeArray = new List<string>{"Choose","Bungalow","Apartment","Semi-Detached","Detached"};
        ...
        {
            comboBoxPropType.DataSource = propertyTypeArray;
            comboBoxType.DataSource = typeArray;
            Load_Table();
        ...
        {
            if (!txtAddress.Text.Any(char.IsDigit) && !txtTown.Text.Any(char.IsDigit))
            {
                if (txtNumRooms.Text.All(char.IsDigit) && txtPrice.Text.All(char.IsDigit) && txtHouseNum.Text.All(char.IsDigit))
                {
                    if (txtAddress.Text == "" || txtTown.Text == "" || comboBoxPropType.Text == "Choose" || txtNumRooms.Text == "" || txtPrice.Text == "" || comboBoxPropType.Text == "Choose")
                    {
                        MessageBox.Show("Enter all necessary details before submitting");
                ...
                {
                    MessageBox.Show("Cant Enter letters for numeric values!");
            ...
            {
                MessageBox.Show("Enter correct values for Address and Town!");
            }
